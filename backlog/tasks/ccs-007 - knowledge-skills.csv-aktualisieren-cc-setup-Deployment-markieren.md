...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 skills.csv spiegelt den aktuellen Skill-Bestand wider (Merges und Konsolidierungen eingearbeitet)
- [ ] #2 skills.csv kennzeichnet die via cc-setup deployten Skills (Tier-1 aus BUNDLE-MANIFEST.md)
<!-- AC:END -->
